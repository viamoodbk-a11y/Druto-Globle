...
const isProduction = typeof window !== 'undefined' && (window.location.hostname === 'druto.me' || window.location.hostname === 'druto-globle.vercel.app' || window.location.hostname === 'druto.me');
