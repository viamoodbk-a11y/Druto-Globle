...
-- Explicitly grant access so the API can find the function
GRANT EXECUTE ON FUNCTION get_master_admin_stats_v3(UUID, TEXT) TO anon;
GRANT EXECUTE ON FUNCTION get_master_admin_stats_v3(UUID, TEXT) TO authenticated;
GRANT EXECUTE ON FUNCTION get_master_admin_stats_v3(UUID, TEXT) TO service_role;
